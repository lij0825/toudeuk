            ...
            <div className="bg-white bg-opacity-20 backdrop-blur-lg p-6 rounded-2xl shadow-lg text-center border border-opacity-20 border-white max-w-sm mx-2">
              ...
              {reward && (
                <>
                  ...
                  <p className="text-white mb-2"><span className="font-bold">최다 클릭자:</span> {reward?.maxClicker?.nickname}</p>
                  <p className="text-white mb-2"><span className="font-bold">마지막 클릭자:</span> {reward?.winner?.nickname}</p>
                  ...
                  <ul className="text-white text-sm space-y-2">
                    <li><span className="font-semibold">첫번째 클릭자:</span> {reward?.firstClicker?.nickname}</li>
                    {reward?.middleRewardUsers?.map((user, index) => (
                      <li key={index}>
                        <span className="font-semibold">{user.clickCount}번째 클릭자:</span> {user.nickname}
                      </li>
                    ))}
                  </ul>
                </>
