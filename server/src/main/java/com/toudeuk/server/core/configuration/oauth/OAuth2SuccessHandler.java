...
import com.toudeuk.server.core.util.CookieUtil;
import com.toudeuk.server.domain.user.dto.oauth.CustomOAuth2User;
import com.toudeuk.server.domain.user.dto.token.TokenDetails;
...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
	...
	// 액세스 토큰을 패스에 추가
	private String getTargetUrl(String accessToken, LocalDateTime accessTokenExpireTime, String refreshToken,
